...
class VideoListTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.video = Video.objects.create(title='TEST title', description='TEST description', url='TEST url')
    ...
    def test_list_videos(self):
        ...
        """
        Video.objects.create(title='TEST title', description='TEST description', url='TEST url')
...
class CategoryVideoDetailTests(APITestCase):
    ...
    def setUp(self):
        self.category = Category.objects.create(title='FREE', color='TEST color')
        self.video1 = Video.objects.create(title='TEST title', description='TEST description', url='TEST url')
        self.video2 = Video.objects.create(title='TEST title', description='TEST description', url='TEST url')
